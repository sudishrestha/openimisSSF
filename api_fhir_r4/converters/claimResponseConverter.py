...
class ClaimResponseConverter(BaseFHIRConverter):
    ...
    def to_fhir_obj(cls, imis_claim):
        ...
        fhir_claim_response.extension.append(cls.getSchemeInformation(imis_claim.product_id))
        fhir_claim_response.extension.append(cls.getSubProductInformation(imis_claim.subProduct_id))
        ...
        cls.build_fhir_accident(fhir_claim_response, imis_claim)
    ...
    _CODE_DISPLAY_STATUS = {
        ...
        6: R4ClaimConfig.get_fhir_claim_status_checked_code(),
    ...
    def build_fhir_item_adjudication(cls, item, rejected_reason, imis_claim):
        ...
        if rejected_reason == 0 and imis_claim.status != 1:
            ...
            if imis_claim.status >= 6:
                price_approved = cls.__build_item_price(item.price_approved)
                adjudications.append(build_processed_adjudication(6, price_approved))
