...
class ClaimResponse(DomainResource):
    ...
    is_admitted = Property('is_admitted', str)
    condition_of_wound = Property('condition_of_wound', str)
    injured_body_part = Property('injured_body_part', str)
    is_disable = Property('is_disable', str)
    is_dead = Property('is_dead', str)
    accident_description = Property('accident_description', str)
    reason_of_sickness = Property('reason_of_sickness', str)
    discharge_type = Property('discharge_type', str)
    discharge_summary = Property('discharge_summary', str)
    refer_to_date = Property('refer_to_date', str)
